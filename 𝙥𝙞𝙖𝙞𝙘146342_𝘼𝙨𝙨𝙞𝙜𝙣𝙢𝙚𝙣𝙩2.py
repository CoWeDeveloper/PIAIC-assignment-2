...
def function3():
    ...
    x = np.arange(35,1000,35) #wrtie your code here
    return x
...
def function4():
    ...
    ans = arr[:,[1,0,2]]
    return ans#wrtie your code here
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = [arr,arr*1+1]
    np.hstack(ans) #write your code here 
...
def function14():
    ...
    arr = arr.reshape(8,3) #write your code here
    ans = np.split(arr, 4)
    return ans
...
def function15():
    ...
    arr = arr[np.argsort(arr[:, 1])]  #write your code here 
    return arr
